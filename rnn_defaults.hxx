//Code generated automatically by TMVA for Inference of Model file [rnn_defaults.onnx] at [Sun Jul  4 18:07:17 2021] 
#include<string>
#include<vector>
...
void infer(float* tensor_X){
	...
	for (size_t seq = 0; seq < 3; seq++) {
		size_t feedforward_offset = seq * 5;
		size_t h_offset = seq * 5 + 0;
		size_t feedforward_size = 5;
