//Code generated automatically by TMVA for Inference of Model file [lstm_bidirectional.onnx] at [Thu Jul  8 13:29:49 2021] 
#include<vector>
namespace TMVA_SOFIE_lstm_bidirectional{
namespace BLAS{
...
float tensor_R[72] = {0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001, 0.100000001};
...
void infer(float* tensor_X){
	...
	float op_0_input_gate[18];
	float op_0_output_gate[18];
	float op_0_cell_gate[18];
	float op_0_forget_gate[18];
	float op_0_cell_state[18];
	float op_0_new_cell_state[18];
	...
	BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &op_0_m, &op_0_k, &op_0_alpha, tensor_W + 24, &op_0_k, op_0_input, &op_0_k, &op_0_beta, op_0_ff_input_gate, &op_0_n);
	BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &op_0_m, &op_0_k, &op_0_alpha, tensor_W + 36, &op_0_k, op_0_input, &op_0_k, &op_0_beta, op_0_ff_output_gate, &op_0_n);
	...
	BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &op_0_m, &op_0_k, &op_0_alpha, tensor_W + 30, &op_0_k, op_0_input, &op_0_k, &op_0_beta, op_0_ff_forget_gate, &op_0_n);
	for (size_t seq = 0; seq < 3; seq++) {
		size_t ff_offset = seq * 3;
		size_t gate_offset = seq * 6 + 3;
		std::copy(op_0_ff_input_gate + ff_offset, op_0_ff_input_gate + ff_offset + 3, op_0_input_gate + gate_offset);
		std::copy(op_0_ff_output_gate + ff_offset, op_0_ff_output_gate + ff_offset + 3, op_0_output_gate + gate_offset);
		std::copy(op_0_ff_cell_gate + ff_offset, op_0_ff_cell_gate + ff_offset + 3, op_0_cell_gate + gate_offset);
		std::copy(op_0_ff_forget_gate + ff_offset, op_0_ff_forget_gate + ff_offset + 3, op_0_forget_gate + gate_offset);
	...
	for (size_t seq = 0; seq < 3; seq++) {
		size_t index = 2 - seq;
		int m2 = 1;
		size_t offset = index * 6 + 3;
		if (seq == 0) {
		} else {
			size_t previous_offset = (index + 1) * 6 + 3;
			BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &m2, &op_0_n, &op_0_alpha, tensor_R + 36, &op_0_n, op_0_hidden_state + previous_offset, &op_0_n, &op_0_alpha, op_0_input_gate + offset, &op_0_n);
			BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &m2, &op_0_n, &op_0_alpha, tensor_R + 54, &op_0_n, op_0_hidden_state + previous_offset, &op_0_n, &op_0_alpha, op_0_output_gate + offset, &op_0_n);
			BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &m2, &op_0_n, &op_0_alpha, tensor_R + 63, &op_0_n, op_0_hidden_state + previous_offset, &op_0_n, &op_0_alpha, op_0_cell_gate + offset, &op_0_n);
			BLAS::sgemm_(&op_0_transB, &op_0_transA, &op_0_n, &m2, &op_0_n, &op_0_alpha, tensor_R + 45, &op_0_n, op_0_hidden_state + previous_offset, &op_0_n, &op_0_alpha, op_0_forget_gate + offset, &op_0_n);
		}
		for (size_t i = offset; i < offset + 3; i++) {
			float ex = exp(-2 * op_0_cell_gate[i]);
				op_0_cell_gate[i] = (1. - ex) / (1. + ex);
	...
	std::copy(op_0_hidden_state + 12, op_0_hidden_state + 12 + 3, tensor_Yh);
	std::copy(op_0_hidden_state + 3, op_0_hidden_state + 6, tensor_Yh + 3);
	std::copy(op_0_cell_state + 12, op_0_cell_state + 12 + 3, tensor_Yc);
	std::copy(op_0_cell_state + 3, op_0_cell_state + 6, tensor_Yc + 3);
}
} //TMVA_SOFIE_lstm_bidirectional
